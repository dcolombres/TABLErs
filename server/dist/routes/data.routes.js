...
import { getTables, deleteTable, getSchema, queryData, getDashboardConfig, saveDashboardConfig, getData, } from '../controllers/data.controller.js';
import { createDashboard, getDashboards, getDashboardById, updateDashboard, deleteDashboard, } from '../controllers/dashboard.controller.js'; // Import dashboard controller functions
import { getDataSourcesByDashboardId, deleteDataSource, } from '../controllers/dataSource.controller.js'; // Import data source controller functions
import { getDataSourcePreview, transformDataSource, getChartSuggestions, getTableSuggestions, } from '../controllers/dataSelection.controller.js'; // Import data selection controller functions
